...
if __name__ == "__main__":
    ...
    for i in tqdm(range(len(dataset))):
        ...
        if args.save_depth:
            ...
            if args.depth_format == 'pfm':
                save_pfm(os.path.join(f'results/{args.dataset_name}/depth', f'depth_{i:03d}.pfm'), depth_pred)
                ...
                depths += [depth_pred_]
                imageio.imwrite(os.path.join(f'results/{args.dataset_name}/depth', f'{i:03d}.png'), depth_pred_)
    ...
    imageio.mimsave(os.path.join(f'results/{args.dataset_name}/depth', f'{args.scene_name}.gif'), depth_pred_, fps=30)
